// TriNova Helvetic Group — website enquiry (contact form) handler.
...
module.exports = async function (context, req) {
  ...
  try {
    ...
    context.log("enquiry send failed", send && send.stage, send && send.status, send && send.code, send && send.detail);
